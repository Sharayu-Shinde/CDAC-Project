    ...
    <div className="fp">
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Krushnai Hostel</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Moraya Hostel</span>
        <span className="fpCity">Pune</span>
        <span className="fpPrice">Starting from 5500</span>
        <div className="fpRating">
          <button>9.3</button>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Shivalay Hostel</span>
        <span className="fpCity">Pune</span>
        <span className="fpPrice">5700</span>
        <div className="fpRating">
          <button>8.8</button>
          <span>Excellent</span>
        </div>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Siddhi Hostel</span>
        <span className="fpCity">Pune</span>
        <span className="fpPrice">6000</span>
        <div className="fpRating">
          <button>8.9</button>
          <span>Excellent</span>
        </div>
