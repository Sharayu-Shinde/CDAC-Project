...
export default function AboutUsCards(){
    return(
        <>
            ...
            <Col sm={8}>
                <p className="text-center fw-bold lh-lg" style={{padding:"3rem"}}>
                Our mission is to provide students
                with affordable and comfortable 
                accommodation options. We understand that 
                staying away from home can be expensive, 
        ...
        <Card.Body>
            <Card.Title><b><i>Sharayu Shinde</i></b></Card.Title>
            <Card.Text>
                Team Lead
          </Card.Text>
        </Card.Body>
        ...
        <Card style={{ width: '12rem', border:"1px solid goldernrod"}}>
          <Card.Img variant="top" src="https://media.istockphoto.com/id/1369199360/photo/portrait-of-a-handsome-young-businessman-working-in-office.jpg?b=1&s=170667a&w=0&k=20&c=9cS9Dj2jKbJGqfI0X0U-jZNURFc-foLzDm1Ls-Q_fgo=" />
        <Card.Body>
            <Card.Title><b><i>Tanisha</i></b></Card.Title>
            <Card.Text>
                Team Member
          </Card.Text>
        </Card.Body>
