...
import { redirect, Redirect, Navigate,useNavigate } from "react-router-dom";
...
console.log(this.state);
    ...
    if (Object.keys(errors).length === 0) {
      ...
      console.log("andhva");
      axios.post("http://localhost:8080/urbanstay/newuser",this.state)
      .then((res)=>{
        console.log("dhasgda");
    ...
    render() {
        return (
          ...
          <div className="container" id="form-container" style={{padding:"1%"}}>
            <form>
                <h3>Let's Start Journey with bookmyhostel</h3>
                <hr id="hrLine"/>
