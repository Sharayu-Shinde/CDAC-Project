    ...
    <>
      <footer>
          ...
          <div className="footer-bottom--section">
              <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="/" target="_blank" rel="noopener noreferrer">bookmyhostel2023@gmail.com</a></span>
          </div>
        </div>
        </footer>
